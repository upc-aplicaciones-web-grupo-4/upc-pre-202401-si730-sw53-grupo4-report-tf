...
El URL del repositorio se encuentra en: https://github.com/upc-aplicaciones-web-grupo-4/upc-pre-202401-si730-sw53-grupo4-report-tp
...
| - | - | - |
|c1. Participa en equipos multidisciplinarios con eficacia, eficiencia y objetividad, en el marco de un proyecto en soluciones de ingeniería de software.|<p>**Astuyauri Calderon Jherson David**	</p><p>TB1: Para esta entrega, me enfoqué en comunicar oralmente el problem statement y los resúmenes de entrevistas a mi equipo. Durante nuestras reuniones, aseguré que mi presentación fuera clara y accesible para todos los niveles jerárquicos y especialidades, facilitando así una comprensión común de los desafíos y objetivos del proyecto.<p>TP1:Al trabajar en equipo me he comunicado de forma asertiva y clara con mis compañeros para coordinar los avances, mejoras y demás del desarrollo de la aplicación web en el segundo sprint. </p><p>TB2: En esta entrega, trabajé con mi equipo en el proyecto HormonalCare, desarrollando el endpoint de medications en el backend.Asimismo colabore en las correciones del frontend. Comunicaba mis avances y problemas de forma clara, ayudando a que todos entendieran y pudiéramos trabajar mejor juntos.  </p><p>TF: Para este trabajo final, me destaqué por mi habilidad para comunicar oralmente el problem statement y los resúmenes de entrevistas, asegurando una comprensión común entre todos los niveles jerárquicos y especialidades del equipo. Contribuí significativamente al desarrollo de la aplicación web en el segundo sprint, coordinando avances y mejoras tanto en el backend, específicamente en el desarrollo de endpoints de medications, como en correcciones clave del frontend. Mi comunicación clara y proactiva facilitó un ambiente colaborativo que optimizó el trabajo del equipo multidisciplinario. </p><p>**Chinchihualpa Saldarriaga Luis Sebastian**	</p><p>TB1: En este trabajo, presenté oralmente nuestras ideas y enfoques durante el proceso de selección del tema del proyecto a diversos públicos, incluyendo desarrolladores, médicos y pacientes. Me aseguré de adaptar mi lenguaje para garantizar que los conceptos técnicos y médicos fueran entendidos adecuadamente por todos, especialmente durante las entrevistas a médicos endocrinólogos para definir claramente las funcionalidades necesarias. </p> <p>TP1: En reuniones de equipo, comuniqué de manera clara y objetiva el progreso y los desafíos del proyecto, adaptando mi enfoque según la audiencia. Utilicé medios audiovisuales adecuados y facilité sesiones de retroalimentación para fomentar la colaboración y la comprensión. Antes de emitir juicios críticos, escuché activamente a mis compañeros y buscando siempre la conciliación para avanzar de manera efectiva en el proyecto.</p> <p>TB2: En esta fase del proyecto, participé activamente en el equipo multidisciplinario, colaborando eficazmente con mis compañeros. Nos enfocamos en la implementación del backend y en la configuración de las bases de datos y API necesarias. Mi enfoque se mantuvo en la eficiencia y la objetividad, asegurando que cada miembro del equipo comprendiera sus responsabilidades y que las tareas se completaran según lo planificado. Promoví un ambiente de trabajo colaborativo, facilitando reuniones regulares para discutir el progreso y resolver cualquier desafío técnico o de comunicación que surgiera. Esta colaboración efectiva nos permitió avanzar en el desarrollo de soluciones de ingeniería de software de manera coherente y alineada con los objetivos del proyecto. </p><p>TF: Durante este trabajo final, me destacé por mi capacidad para adaptar mi comunicación a diferentes públicos, asegurando que tanto desarrolladores como médicos y pacientes comprendieran claramente los enfoques y decisiones del proyecto. En el primer periodo, demostré habilidades de comunicación efectiva al presentar el perfil de paciente, integrando feedback y facilitando sesiones de retroalimentación que fortalecieron la colaboración del equipo. En la fase actual del proyecto, he sido fundamental en el desarrollo del backend, especialmente en la implementación de bases de datos y API necesarias, manteniendo un enfoque en la eficiencia y objetividad que ha contribuido al progreso coordinado del equipo. </p><p>**Lostaunau Pereira Estéfano Sebatián**</p><p>TB1: Para esta primera entrega, me encargué de presentar oralmente nuestras Hypothesis Statements y User Stories al equipo y a los stakeholders, explicando cómo nuestras estrategias competirían en el mercado. Además, comuniqué los detalles de los Class Diagrams y el Database Diagram asegurándome de que todos los niveles técnicos y no técnicos entendieran nuestra propuesta de arquitectura y diseño de datos. </p> <p>TP1: Para esta entrega, me encargué de presentar oralmente el perfil de paciente. Me comuniqué técnicamente para expresar mis ideas para mejorar el desarrollo del proyecto. </p> <p>TB2: En esta entrega, participé en un equipo multidisciplinario desarrollando el backend de "typeexam," "medicalexam," y "patient." Mi enfoque fue siempre la eficacia, eficiencia y objetividad. Comunicaba los avances de manera clara y comprensible para todo el equipo, incluyendo miembros con diferentes especialidades. Implementamos estos módulos siguiendo los estándares establecidos y asegurando una alta calidad en los datos y las APIs. Adapté mis explicaciones a diferentes niveles de comprensión, lo que facilitó la colaboración y la retroalimentación. Esta dinámica de trabajo contribuyó significativamente al progreso efectivo del proyecto, asegurando que cada disciplina involucrada pudiera aportar y avanzar de manera coordinada. </p> <p>TF: He jugado un papel crucial en este trabajo final al comunicar claramente las Hypothesis Statements, User Stories y detalles técnicos como los Class Diagrams y Database Diagram. Durante el primer periodo, me enfoqué en mejorar continuamente el desarrollo del backend para módulos críticos como "typeexam," "medicalexam," y "patient." Mi enfoque en la calidad de datos y APIs ha sido fundamental para mantener estándares altos y asegurar la comprensión completa del equipo multidisciplinario, promoviendo así una colaboración efectiva y alineada con los objetivos del proyecto. </p><p>**Quispesivana Torres Claudio Sandro**</p><p>TB1: Para el desarrollo de nuestra guía de estilos, presenté y justifiqué la selección de colores y diseños durante las reuniones con el equipo y stakeholders, explicando cómo estos elementos influirían positivamente en la experiencia de los usuarios, tanto pacientes como médicos. Me aseguré de que todos los participantes comprendieran la importancia de una interfaz amigable y acorde a las necesidades del usuario.</p><p> TP1: Durante nuestra colaboración en equipo, me he enfocado en mantener una comunicación abierta y clara, compartiendo de manera efectiva los avances y desafíos del proyecto. He adaptado mi estilo de comunicación según las preferencias y necesidades del grupo, utilizando herramientas visuales y facilitando sesiones de retroalimentación para promover la colaboración y el entendimiento mutuo. </p> <p>En esta etapa, me encargué del desarrollo del backend para los módulos de "doctor," "MedicalAppointment," y "Treatment," asegurando una comunicación continua y clara con todo el equipo. Seguí estrictamente los estándares y directrices establecidos, ajustando mis explicaciones según los distintos niveles de conocimiento y especializaciones del equipo para garantizar una comprensión completa de los aspectos técnicos. Esta metodología facilitó la integración de feedback y mejoró significativamente la colaboración, contribuyendo al éxito y avance del proyecto.</p><p>TF: He sido fundamental en este trabajo final al liderar la presentación y justificación de la guía de estilos, asegurando que todos los stakeholders entendieran la importancia de una interfaz amigable para usuarios médicos y pacientes. En el primer periodo, demostré habilidades excepcionales de comunicación al desarrollar el backend para módulos críticos como "doctor," "MedicalAppointment," y "Treatment," manteniendo una comunicación continua y clara con todo el equipo. Mi adaptabilidad y capacidad para explicar conceptos técnicos a diferentes niveles de comprensión han mejorado significativamente la colaboración y el progreso del proyecto, asegurando una implementación exitosa y alineada con los estándares establecidos. </p><p>**Morales Calderon Hernan Emilio:**</p><p>TB1: En esta entrega, fui responsable de comunicar los avances de nuestros Lean UX Canvas y de compartir los insights obtenidos de las entrevistas con pacientes durante las reuniones de equipo. Presenté los mock-ups de la aplicación web, asegurándome de que cada elemento fuera comprendido claramente por todos los miembros del equipo, facilitando así una visión integrada y coherente del proyecto. </p> <p>TP1: Esta entrega, en las reuniones del equipo, comuniqué de manera clara y objetiva el avance del proyecto, adaptando mi mensaje según quién estuviera escuchando. También dirigí sesiones donde todos pudimos dar opiniones y resolver problemas juntos. Escuché bien a mis compañeros antes de opinar, buscando siempre soluciones que todos aceptaran.</p> <p>TB2: En este proyecto de HormonalCare, colaboré con mi equipo en el desarrollo de los endpoints para el diagnóstico y el informe externo en el backend. También participé en la corrección del frontend, trabajando en el chat de doctor a doctor, el chat de doctor a paciente y las notificaciones. Me aseguré de comunicar mis avances y problemas de manera clara, facilitando la comprensión y mejorando la colaboración entre todos.</p><p>TF: He desempeñado un rol crucial en este trabajo final al comunicar efectivamente los avances de los Lean UX Canvas y los insights obtenidos de las entrevistas con pacientes. Durante el primer periodo, lideré sesiones de equipo y resolví problemas de manera colaborativa. En la fase actual del proyecto, he contribuido significativamente al desarrollo del backend para módulos esenciales como el diagnóstico y el informe externo, así como en correcciones críticas del frontend. Mi enfoque en la comunicación clara y la gestión efectiva del equipo ha facilitado un progreso cohesivo y alineado con los objetivos del proyecto. </p>|<br>TB1:  En conclusión, durante la fase inicial del proyecto hemos integrado las ideas y esfuerzos de todos los miembros del equipo, asegurando que nuestras actividades estén alineadas con los objetivos y parámetros establecidos. Esta colaboración ha sido fundamental para avanzar en el desarrollo del proyecto de manera efectiva y enfocada.<br> TP1: En el trabajo de profundización, hemos consolidado y ampliado nuestra capacidad para comunicar oralmente ideas y resultados de manera objetiva a audiencias diversas, incluyendo diferentes especialidades y niveles jerárquicos. Durante el Sprint 2, enfocado en la implementación de las historias de usuario core, hemos mejorado nuestra habilidad para transmitir con claridad y precisión el progreso del proyecto, así como para recibir y responder a retroalimentación constructiva. Esta fase ha evidenciado un nivel avanzado de comunicación oral, fundamental para el éxito continuo del proyecto de ingeniería.<p>**TB2: A través de los esfuerzos realizados en esta etapa del proyecto, se ha demostrado una comunicación eficaz y clara con todo el equipo multidisciplinario. La adaptación del lenguaje y la metodología de trabajo a las necesidades de cada especialidad ha mejorado la integración del feedback y la colaboración, lo cual ha sido crucial para el progreso y éxito del proyecto.</p> <p>TF: El equipo ha demostrado un compromiso excepcional y habilidades sobresalientes en su participación en el proyecto, cumpliendo con el objetivo de trabajar eficazmente en un entorno multidisciplinario para desarrollar soluciones de ingeniería de software de alta calidad. Cada miembro ha jugado un papel crucial, desde comunicar claramente los requisitos técnicos y funcionales hasta liderar el desarrollo tanto del backend como del frontend, asegurando una integración fluida de bases de datos y APIs esenciales. La comunicación efectiva, adaptabilidad y enfoque en la calidad han sido pilares fundamentales que han permitido avanzar de manera coherente y alineada con los objetivos del proyecto. Este enfoque colaborativo ha no solo optimizado el progreso del proyecto, sino también fortalecido el equipo como unidad cohesionada y eficiente.</p>|
|c2. Conoce al menos un sector empresarial o dominio de aplicación de soluciones de software.|<p>**Astuyauri Calderon Jherson David**	</p><p>TB1: En esta entrega, me dediqué a la elaboración de customer journey mappings y los escenarios As is y To be para ambos segmentos objetivos, asegurándome de documentar estos procesos de manera clara y detallada. Redacté las historias de usuario, el product backlog y los detalles del Sprint I, presentando la información de manera que fuera accesible y comprensible para todos los miembros del equipo y stakeholders, independientemente de su especialidad técnica.</p><p>TP1: En esta entrega, contribuí al colocar varias ideas en onenote para definir los nombres de cada feature. También, anotar las cosas que debemos mejorar y algunos puntos importantes que debemos tener en cuenta para esta segunda entrega.</p><p>TB2:Trabajé en el proyecto HormonalCare en la parte de backend. Hice el endpoint de medications, asegurándome de que cumpliera con las necesidades del área. También ayudé a documentar el proyecto, explicando las soluciones y mi comprensión de este campo.</p><p>TF: Para este trabajo final, me enfoqué en la elaboración detallada de customer journey mappings y escenarios As is y To be para ambos segmentos objetivos, asegurando una documentación clara y accesible para todos los stakeholders. Contribuí significativamente al desarrollo del backend del proyecto HormonalCare, especialmente en la implementación del endpoint de medications, garantizando que cumpliera con las necesidades del área de salud. Mi capacidad para explicar soluciones y comprender profundamente este campo demostró mi conocimiento del sector empresarial de la salud, facilitando la integración efectiva de tecnologías de software en este ámbito. </p><p>**Chinchihualpa Saldarriaga Luis Sebastian**	</p><p>TB1: Utilizo un lenguaje claro y conciso al redactar los informes de progreso y documentación técnica relacionada con el proyecto. Me aseguro de que la información esté organizada de manera lógica y fácil de entender para diferentes audiencias, adaptando el nivel de detalle y tecnicismo según sea necesario. Además, mantengo una postura objetiva al presentar resultados y conclusiones, respaldando mis afirmaciones con datos y evidencia cuando sea posible. </p><p>TP1: Durante la segunda entrega del proyecto, me centré en comunicar de manera clara y objetiva las ideas y los resultados a través de la documentación revisada y mejorada, así como en la web application desarrollada. Aseguré que la información fuera comprensible para diferentes audiencias, buscando retroalimentación para garantizar la precisión y utilidad de lo comunicado.</p> <p>TB2: Durante esta fase del proyecto, profundicé en el conocimiento del sector de la salud, específicamente en la creación de soluciones de software para la gestión de datos médicos. Mi participación incluyó el desarrollo de bases de datos y API para facilitar la comunicación entre médico y pacientes. Para asegurar una implementación adecuada, investigué las necesidades específicas de los usuarios finales, como médicos endocrinólogos, adaptando las funcionalidades del software para cumplir con estos requisitos. Este enfoque no solo mejoró mi comprensión del sector de la salud, sino que también permitió desarrollar una solución de software que atendiera de manera eficaz las demandas de este dominio.</p><p>TF: Durante este trabajo final, demostré un dominio excepcional al redactar informes de progreso y documentación técnica, adaptando mi comunicación para diferentes audiencias y niveles de tecnicismo. Mi enfoque en la objetividad y la presentación de datos respaldados por evidencia fue crucial para comunicar claramente ideas y resultados durante el desarrollo del proyecto. En la fase actual, mi profundo conocimiento del sector de la salud me permitió desarrollar soluciones de software específicas para la gestión de datos médicos, destacándome en la creación de bases de datos y APIs que mejoran la comunicación médico-paciente.</p> <p>**Lostaunau Pereira Estéfano Sebatián**</p><p>TB1: Contribuí activamente redactando secciones clave de nuestra documentación técnica y reportes de progreso. Mi enfoque estuvo en garantizar que la comunicación escrita reflejara objetividad y claridad, adecuando el contenido a las necesidades de comprensión de nuestros diversos stakeholders, desde ingenieros hasta inversores y usuarios finales.</p></p> <p>TP1: Para esta entrega, me comuniqué de manera clara y especifica para desarrollar mis ideas, contribuyendo con el desarrollo de nuestra aplicacion web. </p> <p>TB2: Durante esta etapa del proyecto, apliqué mis conocimientos en el sector de la salud para asegurar que las soluciones de software fueran adecuadas y efectivas para este dominio específico. Me aseguré de comunicar ideas y resultados de manera clara, elaborando documentación detallada y estructurada. Adapté el nivel de tecnicismo para diferentes públicos y niveles jerárquicos dentro del sector de la salud. Fomenté la revisión y retroalimentación constante, lo que mejoró la calidad de la comunicación y facilitó decisiones informadas en el desarrollo del proyecto. Este enfoque contribuyó a que las soluciones de software estuvieran alineadas con las necesidades y requerimientos específicos del sector. </p> <p>TF: Jugué un papel fundamental al redactar secciones clave de la documentación técnica y reportes de progreso, asegurando una comunicación clara y estructurada para diversos stakeholders. Mi enfoque en la adaptabilidad y en la comprensión profunda del sector de la salud fue evidente en el desarrollo del backend para módulos críticos como "doctor," "MedicalAppointment," y "Treatment." Demostré mi capacidad para implementar soluciones de software que cumplen con los estándares específicos del sector, mejorando la calidad y eficiencia en la gestión de datos médicos.</p><p>**Morales Calderon Hernan Emilio:** </p><p>TB1: Durante esta entrega, fui responsable de documentar el proceso de los Lean UX Canvas y las entrevistas realizadas al segmento de pacientes. Me aseguré de que todos los detalles estuvieran claramente redactados, permitiendo que el equipo y los stakeholders comprendieran los objetivos y los insights obtenidos. También contribuí a la redacción detallada de las especificaciones para los mock-ups de la aplicación web.</p><p>TP1: Esta entrega, al trabajar en la documentación y la aplicación web, me aseguré de que todo estuviera fácil de entender para todos. Pedí opiniones a otros compañeros y personas externas para mejorar lo que escribí y desarrollé. Esto muestra mi compromiso con la buena comunicación escrita y oral, fundamentales para tener éxito en proyectos de ingeniería.</p><p>TB2: En esta etapa, mientras trabajaba en la documentación y la aplicación web, me esforcé para que todo fuera comprensible para todos los involucrados. Solicité retroalimentación de mis compañeros y de personas externas para perfeccionar tanto la escritura como el desarrollo. Esto demuestra mi dedicación a la comunicación efectiva, tanto escrita como verbal, esencial para el éxito en proyectos de ingeniería.</p><br><p>TF: Durante este trabajo final, lideré la documentación detallada de los Lean UX Canvas y las entrevistas con pacientes, asegurando que todos los detalles fueran claros para el equipo y los stakeholders. Mi compromiso con la comunicación efectiva fue evidente en la elaboración de mock-ups y especificaciones para la aplicación web, facilitando la comprensión y la implementación precisa de los requisitos del proyecto. Apliqué mi conocimiento del sector de la salud para desarrollar soluciones de software que responden a las necesidades específicas de los usuarios finales, destacándome en la comunicación oral y escrita dentro de este dominio.</p><p>**Quispesivana Torres Claudio Sandro**</p><p>TB1: En mi contribución a la aplicación de wireframes y mock-ups, me enfoqué en redactar documentos que siguieran las Style Guidelines y Architecture Information establecidas. Aseguré que la documentación fuera precisa y fácil de entender, permitiendo que tanto desarrolladores técnicos como personal no técnico pudieran seguir y comprender las especificaciones y el impacto visual propuesto para la aplicación.</p><p> TP1: Para esta entrega, me enfoque en el desarrollo de una Fake API con la contribución de mis compañeros al momento de escoger que datos serían los más relevantes a la hora de hacer validaciones en la aplicación. Además de la contribución para el feature doctor-doctor-collaboration dentro del bounded context Comunication Managment. <p> TB2: Durante esta fase del proyecto, aseguré la comunicación escrita de nuestros avances y resultados de manera objetiva y clara. Elaboré documentación detallada y estructurada sobre el progreso del backend, adaptando el nivel técnico según el público destinatario, ya sea técnico o no. Fomenté la revisión y retroalimentación de esta documentación por parte del equipo, lo cual mejoró la calidad de la comunicación escrita y facilitó la toma de decisiones informadas. </p> </p><p>TF: En mi contribución al proyecto, me destacé en la aplicación de wireframes y mock-ups, asegurando que la documentación siguiera las directrices de estilo y arquitectura establecidas. Mi habilidad para desarrollar una Fake API y contribuir al feature doctor-doctor-collaboration demostró mi conocimiento profundo del sector de la salud y mi capacidad para aplicar soluciones innovadoras en software. Facilité la comunicación efectiva de avances y resultados a través de una documentación estructurada y adaptada, apoyando decisiones informadas y mejoras continuas en el proyecto.</p>|<br>TB1: En resumen, en esta etapa del proyecto nos enfocamos en realizar el desarrollo tanto del reporte como de la aplicación web de manera colaborativa, con cada miembro del equipo trabajando en sus respectivas ramas y coordinando los cambios para prevenir conflictos que surgieron durante la depuración en el framework Vue, especialmente en la capa de presentación para los usuarios.<br> TP1: En el trabajo de profundización, hemos avanzado significativamente en nuestra habilidad para comunicar de manera escrita ideas y resultados de manera objetiva, adaptándonos a públicos de diferentes especialidades y niveles jerárquicos. Durante la colaboración en el desarrollo del reporte y la aplicación web, hemos perfeccionado nuestra capacidad para coordinar cambios y prevenir conflictos, especialmente en la depuración en Vue. Este avance evidencia una comunicación escrita más efectiva y precisa, crucial para el éxito continuo del proyecto en ingeniería.<p>**TB2: Durante esta etapa del proyecto, se ha demostrado un sólido conocimiento del dominio de aplicación de las soluciones de software. La documentación detallada y estructurada ha permitido una comprensión clara de los avances del backend, adaptada tanto para audiencias técnicas como no técnicas, facilitando la toma de decisiones informadas y mejorando la calidad del proyecto.</p><p>TF: En este trabajo final, se ha demostrado la importancia de integrar conocimientos específicos del sector empresarial de la salud con habilidades técnicas avanzadas en el desarrollo de soluciones de software. Cada miembro del equipo ha aportado su experiencia y conocimientos especializados, contribuyendo de manera significativa al progreso del proyecto HormonalCare. La capacidad para adaptar la comunicación según las necesidades del público, ya sea técnico o no, ha sido fundamental para asegurar una colaboración efectiva y una implementación exitosa. La documentación clara, estructurada y adaptada, así como el enfoque en la objetividad y eficiencia, han permitido que el equipo multidisciplinario trabaje de manera cohesiva y alineada con los objetivos del proyecto. En conjunto, estos esfuerzos han resultado en una solución de software robusta y alineada con las necesidades específicas del sector de la salud, mejorando la gestión de datos médicos y la comunicación entre médicos y pacientes. </p>|
...
|---|---|
|  <p>Nombres:  Luis Hernán</p> <p>Apellidos: Chinchihualpa Montes</p> <p> Edad: 53 años</p> <p> Localidad: La Molina </p> <p> Timing: 0 </p> <p> Duración: 4:59 </p> <p style="max-width: 350px;"> Link: [https://upcedupe-my.sharepoint.com/:v:/g/personal/u202211742_upc_edu_pe/EV78DJG4fg9HrtTuFI6ZrUwByr9O-BItsPbsGTt7E5lqwQ?e=dJPWAP&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D]</p>| <img src="images/EntrevistaLuisChinchihualpa.png" width=400> |
...
| Datos del médico: | Entrevista |
|---|---|
|  <p>Nombres:  Ricardo </p> <p>Apellidos: Durand</p> <p> Edad: 48 años</p> <p> Localidad: Surco</p> <p> Timing: 4:59 </p> <p> Duración: 4:59 </p> <p style="max-width: 350px;"> Link: [https://upcedupe-my.sharepoint.com/:v:/g/personal/u202211742_upc_edu_pe/EV78DJG4fg9HrtTuFI6ZrUwByr9O-BItsPbsGTt7E5lqwQ?e=dJPWAP&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D]</p> | <img src="images/EntrevistaRicardoDurand.png" width=400>|
...
| Datos del médico: | Entrevista |
|---|---|
|  <p>Nombres:  Roxana </p> <p>Apellidos: Podésta</p> <p> Edad: 38 años</p> <p> Localidad: La Victoria </p> <p> Timing: 9.58 </p> <p> Duración: 5:00 </p> <p style="max-width: 350px;"> Link: [https://upcedupe-my.sharepoint.com/:v:/g/personal/u202211742_upc_edu_pe/EV78DJG4fg9HrtTuFI6ZrUwByr9O-BItsPbsGTt7E5lqwQ?e=dJPWAP&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D]</p>| <img src="images/EntrevistaRoxanaPodesta.png" width=400>|
...
|---|---|
|  <p>Nombres:  Joaquin </p> <p>Apellidos: Benavides</p> <p> Edad: 20 años</p> <p> Localidad: San Miguel </p> <p> Timing: 14:58 </p> <p> Duración: 4:52 </p> <p style="max-width: 350px;"> Link: [https://upcedupe-my.sharepoint.com/:v:/g/personal/u202211742_upc_edu_pe/EV78DJG4fg9HrtTuFI6ZrUwByr9O-BItsPbsGTt7E5lqwQ?e=dJPWAP&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D]</p> | <img src="images/EntrevistaJoaquinBenavides.png" width=400>|
...
| Datos del paciente: | Entrevista |
|---|---|
|  <p>Nombres:  Arnhol Alfredo </p> <p>Apellidos: Castrejón Calderon</p> <p> Edad: 19 años.</p> <p> Localidad: La Victoria </p> <p> Timing: 19:50 </p> <p> Duración: 4:52 </p> <p style="max-width: 350px;"> Link: [https://upcedupe-my.sharepoint.com/:v:/g/personal/u202211742_upc_edu_pe/EV78DJG4fg9HrtTuFI6ZrUwByr9O-BItsPbsGTt7E5lqwQ?e=dJPWAP&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D]</p> | <img src="images/entrevista-paciente-2.png" width=400> |
...
• Se sigue el estándar de estilo de JavaScript de Google para garantizar un código coherente y legible.

• Las declaraciones de variables se realizan al principio de su ámbito.

• Se da preferencia al uso de const y let en lugar de var.

• Se emplea la convención de camelCase para nombrar variables y funciones.
...
<tr><td colspan="1" valign="top">T02</td><td colspan="1" valign="top">Implementación de la Sección de Planes</td><td colspan="1" valign="top">Codificar la sección de planes conforme al diseño, utilizando prácticas de desarrollo web responsivo para asegurar su correcta visualización en cualquier dispositivo.</td><td colspan="1" valign="top">Hernan</td><td colspan="1" valign="top">5</td><td colspan="1" valign="top">Done</td></tr>
...
<tr><td colspan="1" valign="top">T02</td><td colspan="1" valign="top">Desarrollar el Footer</td><td colspan="1" valign="top">Codificar el footer basándose en el diseño aprobado, utilizando tecnologías web estándar para garantizar su funcionamiento.</td><td colspan="1" valign="top">Hernan</td><td colspan="1" valign="top">5</td><td colspan="1" valign="top">Done</td></tr>
...
<tr><td colspan="1" rowspan="3" valign="top">US05</td><td colspan="1" rowspan="3" valign="top">Comunicación directa con el equipo de soporte.</td><td colspan="1" valign="top">T01</td><td colspan="1" valign="top">Diseñar Formulario de Contacto</td><td colspan="1" valign="top">Crear un diseño para un formulario de contacto o chat en vivo que permita a los visitantes enviar mensajes directos al equipo de soporte. </td><td colspan="1" valign="top">Hernan</td><td colspan="1" valign="top">3</td><td colspan="1" valign="top">Done</td></tr>
...
|Location|Reunión realizada mediante Discord|
|Prepared By|Astuyauri Calderon Jherson David|
|Attendees (to planning meeting)|Astuyauri Calderon Jherson David / Chinchihualpa Saldarriaga Luis Sebastian/Morales Calderon Hernan Emilio/Lostaunau Pereira Estéfano Sebastián	/Quispesivana Torres Claudio Sandro|
|**Sprint Goal & User Stories**||
...
|------|-----------------------------------------------------------------------------------------------------------|--------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------|--------------------|-------------|---------------------|
| US47 | Visualización de la Historia Clínica del paciente por parte del médico                                   | T01: Diseño de la interfaz de Historia Clínica        | Crear un diseño para la interfaz que muestre los datos de la historia clínica del paciente.                                           | 3                  | Hernan    |      Done           |
|      |                                                                                                           | T02: Implementación de la interfaz de Historia Clínica | Codificar la interfaz de la historia clínica basada en el diseño, utilizando tecnologías web estándar.                                | 8                  | Hernan      |      Done           |
...
|      |                                                                                                           | T03: Pruebas del formulario de Diagnóstico y Tratamiento | Realizar pruebas exhaustivas para garantizar que el formulario funcione correctamente y que los datos se guarden adecuadamente.      | 3                  | Hernan     |      In process        |
...
|  <p>Nombres:  Lucia Barbara </p> <p>Apellidos: Quispesivana Tapia</p> <p> Edad: 33 años</p> <p> Localidad: San Juan de Lurigancho</p> <p> Timing: 4:27 </p> <p> Duración: 4:54 </p> <p style="max-width: 350px;"> Link: [https://upcedupe-my.sharepoint.com/:v:/g/personal/u202211742_upc_edu_pe/EU7-RQ5kkB5ElGi5Ae1bC4oB9V9iDf839QcTScYxjdDoTg?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=VhskCH]</p>| |
...
|  <p>Nombres:  Ernesto </p> <p>Apellidos: Requejo</p> <p> Edad: 27 años</p> <p> Localidad: San Isidro </p> <p> Timing: 9.21 </p> <p> Duración: 4:41 </p> <p style="max-width: 350px;"> Link: [https://upcedupe-my.sharepoint.com/:v:/g/personal/u202211742_upc_edu_pe/EU7-RQ5kkB5ElGi5Ae1bC4oB9V9iDf839QcTScYxjdDoTg?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=VhskCH]</p>| |
...
|  <p>Nombres:  Joaquin </p> <p>Apellidos: Benavides</p> <p> Edad: 20 años</p> <p> Localidad: San Miguel </p> <p> Timing: 14:02 </p> <p> Duración: 4:02 </p> <p style="max-width: 350px;"> Link: [https://upcedupe-my.sharepoint.com/:v:/g/personal/u202211742_upc_edu_pe/EU7-RQ5kkB5ElGi5Ae1bC4oB9V9iDf839QcTScYxjdDoTg?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=VhskCH]</p>| |
| Resumen:<p>
...
|  <p>Nombres:  Arnhol Alfredo </p> <p>Apellidos: Castrejón Calderon</p> <p> Edad: 19 años.</p> <p> Localidad: La Victoria </p> <p> Timing: 18:04 </p> <p> Duración: 4:51 </p> <p style="max-width: 350px;"> Link: [https://upcedupe-my.sharepoint.com/:v:/g/personal/u202211742_upc_edu_pe/EU7-RQ5kkB5ElGi5Ae1bC4oB9V9iDf839QcTScYxjdDoTg?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=VhskCH]</p>|  |
...
| Datos del paciente: | Entrevista |
|---|---|
| <img src="https://github.com/upc-aplicaciones-web-grupo-4/upc-pre-202401-si730-sw53-grupo4-report-tp/assets/149616870/4315c9ea-b292-44b7-8d61-cec3bdf7f995" width=400> | |
|  <p>Nombres:  Jeremy Joel </p> <p>Apellidos: Quispe Andia </p> <p> Edad: : 20 años</p> <p> Localidad: San Juan de Lurigancho </p> <p> Timing: 22.55 </p> <p> Duración: 4:59 </p> <p style="max-width: 350px;"> Link: [https://upcedupe-my.sharepoint.com/:v:/g/personal/u202211742_upc_edu_pe/EU7-RQ5kkB5ElGi5Ae1bC4oB9V9iDf839QcTScYxjdDoTg?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=VhskCH]</p>| |
| Resumen:<p> Jeremy, un paciente de 20 años con hipotiroidismo, ha tenido una experiencia en general positiva con HormonalCare. Destaca la interfaz limpia y fácil de usar de la aplicación, que le facilita la gestión de su salud hormonal. Tanto la página de inicio como la interfaz proyectan profesionalismo y confianza, causando una excelente primera impresión. La navegación es intuitiva y está bien organizada, permitiéndole encontrar y utilizar las funciones sin problemas. Alison encontró especialmente útiles los recordatorios de medicación y citas. Le impresionó la sección para encontrar médicos especialistas, ya que le permite ver detalladamente su información antes de contratarlos. No encontró ninguna dificultad. La aplicación cumplió la mayoría de sus expectativas. Gestionar su información médica desde la sección de Historia Médica fue fácil y eficiente, gracias a la buena organización cronológica de los datos.</p> | 
...
**Link video en Youtube:** https://youtu.be/j2XcyUNs1fE (duracion: 2:13)

**Link video en Microsoft Stream** https://upcedupe-my.sharepoint.com/:v:/g/personal/u202215099_upc_edu_pe/EXJj9cieIj1FrVPdCOGKlDcBRXZaW2z2buDuQ_L-oMHnRw?e=RyqCyk&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D
...
Para obtener más ayuda sobre Vue CLI, puedes utilizar el comando `vue --help` o visitar la página de [Referencia de Comandos y Visión General de Vue CLI](https://cli.vuejs.org/guide/).
